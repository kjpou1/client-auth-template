<template>
  <!-- Auth Modal -->
  <div class="fixed z-40 inset-0 overflow-y-auto" id="modal"
          ...
          <ul class="flex flex-wrap mb-4">
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition"
                href="#" @click.prevent="tab = 'signin'"
                :class="{
                  'hover:text-white text-white bg-blue-600': tab === 'signin',
            ...
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition"
                ...
                :class="{
                  ...
                  'hover:text-blue-600': tab === 'signin'
                }">Register</a>
            </li>
          </ul>

          <app-sign-in v-if="tab === 'signin'" />
...
import AppSignIn from './SignInForm.vue';
import AppRegisterForm from './RegisterForm.vue';

export default {
  name: 'Auth',
  components: {
    AppSignIn, AppRegisterForm,
  },
  data() {
    return {
      tab: 'signin',
