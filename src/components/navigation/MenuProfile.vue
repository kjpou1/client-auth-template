...
<template>
  <div class="relative"
    ...
    <router-link
      class="text-white md:mr-8 lg:mr-10 flex items-center hover:text-gray-300"
      :to="{ name: 'profile' }"
      @focus="showMenu"
    ...
    <!-- Hack to make sure we have a space between menu item and top of hover menu -->
    <div class="absolute w-full">&nbsp;</div>
    <transition name="mega-menu-fade">
      <div class="mega-menu absolute normal-case font-normal
                  bg-white shadow-md rounded-lg overflow-hidden
                  w-260 mt-4"
        style="left: -60px; width: 500px"
        v-show="profile_menu_show">
        <div class="flex px-8 py-6 border-b -mx-">
          <ul class="w-1/2 px-4">
            <li class="mb-8">
              <a href="#"
                class="flex group"
                ...
                <span class="ml-2">
                  ...
                  <span class="block text-sm text-gray-600 group-hover:text-blue-800">
...
export default {
  ...
  methods: {
    showMenu() {
      this.profile_menu_show = true;
    },
    hideMenu() {
      this.profile_menu_show = false;
      this.focusedIndex = 0;
    },
    startArrowKeys() {
      if (this.menuItems === null || (this.menuItems !== null && this.menuItems.length === 0)) {
        this.menuItems = document.querySelectorAll('.mega-menu a');
      }
